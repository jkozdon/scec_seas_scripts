...
if ($NARGS != 3 && $NARGS != 4)
{
  print "Usage:   scec_seas_validate_login.pl USER_NAME PASSWORD PROBLEM_NUMBER\n";
  print "Usage:   scec_seas_validate_login.pl USER_NAME USER_NUMBER PASSWORD PROBLEM_NUMBER\n";
  print "Example: scec_seas_validate_login.pl user pass 1\n";
  print "Example: scec_seas_validate_login.pl user 2 pass 1\n";
  exit;
}
